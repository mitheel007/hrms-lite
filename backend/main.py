...
from .models import Employee, EmployeeCreate, Attendance, AttendanceCreate
...
def create_employee(payload: EmployeeCreate):
    with Session(engine) as session:
        # Check duplicates (employee_id or email)
...
@app.post("/employees/{employee_id}/attendance", response_model=Attendance, status_code=status.HTTP_201_CREATED)
